...
namespace Flowlio.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260529111643_AddEnableBankingCredentials")]
    partial class AddEnableBankingCredentials
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flowlio.Domain.BankConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("State")
                        .HasFilter("\"State\" IS NOT NULL AND \"DeletedAt\" IS NULL");

                    b.ToTable("BankConnections", t =>
                        {
                            t.HasCheckConstraint("CK_BankConnection_Country", "char_length(\"AspspCountry\") = 2");
                        });
                });

            modelBuilder.Entity("Flowlio.Domain.Budget", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CategorizationRules", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_CategorizationRule_Amounts", "(\"MinAmount\" IS NULL OR \"MinAmount\" >= 0) AND (\"MaxAmount\" IS NULL OR \"MaxAmount\" >= 0) AND (\"MinAmount\" IS NULL OR \"MaxAmount\" IS NULL OR \"MinAmount\" <= \"MaxAmount\")");
            ...
            modelBuilder.Entity("Flowlio.Domain.EnableBankingCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EnableBankingCredentials");
                });

            modelBuilder.Entity("Flowlio.Domain.ExchangeRate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Flowlio.Domain.Goal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Flowlio.Domain.Transaction", b =>
                {
                    b.HasOne("Flowlio.Domain.CategorizationRule", "AppliedRule")
                        .WithMany()
