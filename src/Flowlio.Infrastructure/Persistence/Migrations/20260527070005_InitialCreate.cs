        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CounterpartyMatch = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    VariableSymbolMatch = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategorizationRules_FamilyId",
                table: "CategorizationRules",
                column: "FamilyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportBatches_FamilyId",
                table: "ImportBatches",
                column: "FamilyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringPayments_FamilyId",
                table: "RecurringPayments",
                column: "FamilyId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_FamilyId_BookingDate",
                table: "Transactions",
                columns: new[] { "FamilyId", "BookingDate" });
